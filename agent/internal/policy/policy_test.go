...
func TestFetchPolicySuccessWithProbeThresholds(t *testing.T) {
	client := NewClientWithHTTP("http://mock.portal", &http.Client{
		Transport: roundTripFunc(func(r *http.Request) (*http.Response, error) {
			...
			"cpu_profile":{"id":"cpu-check-v1","duration_seconds":180,"warmup_seconds":30,"measured_seconds":120,"cooldown_seconds":30,"worker_cap":8,"workload_mix":{"hashing":0.5,"integer":0.3,"matrix":0.2},"acceptance_floor":{"type":"normalized_score","minimum":1}},
			"disk_profile":{"id":"disk-check-v1","duration_seconds":60,"warmup_seconds":10,"measured_seconds":40,"cooldown_seconds":10,"block_size_bytes":4096,"queue_depth":32,"concurrency":4,"read_ratio":0.7,"write_ratio":0.3,"acceptance_floor":{"type":"measured_iops","minimum":1500}},
